...
export default function Inventory ({ signIn }: { signIn: (isLoggedIn: boolean) => void }) {
  ...
  const handleLogout = () => {
    Swal.fire({
      ...
      confirmButtonText: "Yes, To logout"
    }).then((result) => {
        ...
        <div className='grid grid-cols-1 gap-1'>
          ...
          <div className='col-span-1'>
            <div className='grid grid-cols-1'>
              ...
              <Button onClick={handleLogout} className='col-span-1 flex items-center w-full my-2' style={{ justifyContent: 'flex-start' }} startIcon={<MdOutlineLogout/>}>Logout</Button>
            </div>
          </div>
        </div>
      </div>
